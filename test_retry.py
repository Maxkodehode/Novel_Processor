"""
Test with retry logic: Try to collect 20 chapters.
"""
import sys
import time
...
sh._PAGE_DELAY = 5.0  # 5s delay

print("Collecting 20 chapters with 5s delay + retry logic...")
start = time.time()
